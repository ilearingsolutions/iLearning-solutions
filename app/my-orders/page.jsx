    ...
    return (
        <>
            ...
            {loading ? <Loading /> :
                <>
                    {
                        orders.length === 0 ? <div className="h-screen">
                                ...
                                <div className="space-y-5">
                                    ...
                                    {loading ? <Loading /> : (<div className="max-w-5xl border-t border-gray-300 text-sm">
                                        {orders.map((order, index) => (
                                            <div key={index} className="flex flex-col md:flex-row gap-5 justify-between items-center p-5 border-b border-gray-300">
